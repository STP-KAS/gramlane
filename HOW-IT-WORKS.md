...
```powershell
C:\Users\<user>\tools\silverc\silverc.exe `
  C:\Users\<user>\kns\contracts\v1\WorkCredit.sil `
  --constructor-args C:\Users\<user>\kns\contracts\v1\ctor-WorkCredit.json `
  -o C:\Users\<user>\kns\contracts\v1\WorkCredit.json
```

Or `C:\Users\<user>\kns\compile-sil.ps1`. Artifacts are served from `kns/contracts` embed.
