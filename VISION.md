...
| --- | --- | --- |
| POS / spend pile | The till ticket | A dollar, Tether, Circle |
| AI bots / HTTP 402 | The sequenced call | The model’s output |
| Messaging postage | Inclusion of the envelope | The chat app |
| Data transfer | The pull / the write | The dataset’s market price |
| Vault operations | The bump, the pin | The KAS locked in the vault |
